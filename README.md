...
At some point, complete replicas might become available [here](https://movieprops.blog/shop/). You can, however, make your own electronics using the files in the Electronics folder, and use those to build your own replica.
